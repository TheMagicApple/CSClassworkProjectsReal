...
public class TriviaPlus {
	public static Scanner s=new Scanner(System.in);
	
	public static int score=0;
	public static void main(String[] args) {
		System.out.println("Chemistry, geography, or random?(c,g,r)");
		String answer=s.next();
		if(answer.equals("c")) {
			System.out.println(trivia("What is the chemical symbol for antimony?","Sb"));
			System.out.println(trivia("What is the smallest unit of a substance that retains the properties of that substance?","Molecule"));
			System.out.println(trivia("What are substances that control the rates of chemical reactions?","Catalysts"));
			System.out.println(trivia("The temperature at which a gas becomes a liquid is its?","Condensation point"));
			System.out.println(trivia("What metal is liquid at room temperature?","Mercury"));
